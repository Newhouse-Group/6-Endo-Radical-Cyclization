...
print("Extract starting material data")
file_input = input("What is the file name?: ")
filename = file_input + '.out'
file_output = 'ML_data_SM.csv'
...
#set atom numbering for atoms 1 through 11, reading it off the output file if it was there
last_line = lines[-1]
